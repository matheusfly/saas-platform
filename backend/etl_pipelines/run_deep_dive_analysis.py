from deep_dive_analysis import execute_comprehensive_deep_analysis
import json
...
if __name__ == "__main__":
    ...
    sales_funnel_file = 'sales_funnel.xlsx'
    output_file = 'deep_dive_analysis_results.json'

    # Run the ETL pipeline
    print("Starting Deep Dive Financial Analysis ETL process...")
    bi_results = execute_comprehensive_deep_analysis(cash_flow_file, sales_funnel_file)
